using GSE.Forms.Absences;
using GSE.Forms.Employees;
using GSE.Forms.Exams;
using GSE.Forms.Sessions;
using GSE.Forms.Students;
using System;
...
namespace GSE
{
    public partial class MainForm : Form
    {
        ...
        {
            Program.Search.Loader(tBox_Search.Text);
        }
        ...
        private void p_Header_DoubleClick(object sender, EventArgs e)
        {
            ...
            gBox_SchoolName.Location = new Point(ClientSize.Width / 2 - gBox_SchoolName.Size.Width + 290 / 2, ClientSize.Height / 2 - gBox_SchoolName.Size.Height / 2);
            gBox_SchoolName.Anchor = AnchorStyles.None;
        }
    }
}
