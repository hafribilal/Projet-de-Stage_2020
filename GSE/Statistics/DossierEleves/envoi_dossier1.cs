...
namespace GSE.Statistics.DossierEleves {
    ...
    public class envoi_dossier1 : ReportClass {
        
        public envoi_dossier1() {
        }
        
        public override string ResourceName {
            get {
                return "envoi_dossier1.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "GSE.Statistics.DossierEleves.envoi_dossier1.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cachedenvoi_dossier1 : Component, ICachedReport {
        
        public Cachedenvoi_dossier1() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            envoi_dossier1 rpt = new envoi_dossier1();
            rpt.Site = this.Site;
            return rpt;
        }
